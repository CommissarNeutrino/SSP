...
class ChatBot:
    ...
    @method_logger
    def init_messages(self, chat: Chat) -> None:
        """
    ...
    def validate_init(self) -> None:
        ...
        if self._runtime_mode not in ["console", "app"]:
            raise NotImplementedError(self._mode_error)
        return
    ...
    def process_completion(self, completion: RDict) -> Any:
        ...
        # print("completion.choices[0].finish_reason", completion.choices[0].finish_reason)
